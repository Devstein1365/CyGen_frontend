      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-500">
            ...
            <div
              className={`text-3xl font-bold ${hasRealData ? "text-blue-600" : "text-gray-400"}`}
            >
              {hasRealData ? `${telemetry.powerInput}W` : "—"}
            </div>
            <p className="text-xs text-gray-500 mt-2">
              {hasRealData ? "from pedalling" : "Waiting for data..."}
            </p>
          </div>
          ...
          <div className="bg-purple-50 rounded-lg p-4 border-l-4 border-[#953177]">
            ...
            >
              {hasRealData ? `${telemetry.powerOutput}W` : "—"}
            </div>
            <p className="text-xs text-gray-500 mt-2">
              {hasRealData ? "to devices" : "Demo mode"}
            </p>
          </div>
        </div>
